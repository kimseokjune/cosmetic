...
<script language="javascript">
	...
	function set(zip1, zip2, s_ok) {
		opener.document.joinForm.adno1.value = zip1;
		opener.document.joinForm.adno2.value = zip2;
		opener.document.joinForm.ad1.value = s_ok;
		self.close();
	}
</script>
<html>
...
<body onLoad="document.search_form.post_name.focus()">
 ...
 %> <input type="submit" name="submit" value="찾 기"
		...
		<table width="420" border="0" cellspacing="0" align="center">
			...
			<tr>
				<td width="100" bgcolor="aliceblue" align="center"><%=zip1%>-<%=zip2%></td>
				<td width="360"><a
					href="javascript:set('<%=zip1%>','<%=zip2%>','<%=s_ok%>')"><%=s_ok%></a></td>
			</tr>
			<%
				}
				} else {
