...
public class Search2ListService implements Service {
...
//			System.out.println("현재 페이지:"+page);
		...
		try {
			...
			totalRow=dao.selectCount(con, search, name2 ,select);
			//전체 페이지 구하기
			if(totalRow>0)
...
//			System.out.println("endRow:"+endRow);
			...
			// 게시판에 글을 쓴다.
			List<Search> list=dao.search(con,search,startRow,endRow,name2,select);
//			List<Goods> list
...
////			System.out.println("data.getEndPage():"+data.getEndPage());
			...
			request.setAttribute("check5","check4");
