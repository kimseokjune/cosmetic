...
public class SearchListService implements Service {
...
//			System.out.println("endRow:"+endRow);
			...
			List<Search> list=dao.search(con,search,startRow,endRow,name2);
//			request.setAttribute("rnum", search.getRnum());
//			List<Goods> list
...
//			헤드부분에 검색을 했을때 나오는 페이지로 넘어가게 된다
			request.setAttribute("check2", "check2");
			request.setAttribute("check3", "check2");
//			헤드 서치 부분에서 단어를 검색하면 나오는 페이지
			request.setAttribute("row2","row");
			request.setAttribute("row3","row");
