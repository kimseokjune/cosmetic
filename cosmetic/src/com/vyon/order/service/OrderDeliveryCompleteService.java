...
public class OrderDeliveryCompleteService implements Service {

	@Override
	public ForwardInfo process(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		System.out.println("OrderDeliveryCompleteService.process()");
		...
		if (id != null) {
			...
			try {
				...
				orderDao.updateDeliveryComplete(con, id, selectedOrderList);				
