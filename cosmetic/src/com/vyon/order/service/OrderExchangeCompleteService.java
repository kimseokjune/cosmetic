...
public class OrderExchangeCompleteService implements Service {

	@Override
	public ForwardInfo process(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		System.out.println("OrderExchangeCompleteService.process()");
		...
		if (id != null) {
			...
			try {
				...
				orderDao.updateExchangeComplete(con, id, selectedOrderList);				
