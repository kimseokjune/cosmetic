...
public class OrderExchangingService implements Service {

	@Override
	public ForwardInfo process(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		System.out.println("OrderExchangingService.process()");
		...
		if (id != null) {
			...
			try {
				...
				orderDao.updateExchanging(con, selectedOrderList);				
