...
public class OrderRefundProcessService implements Service {

	@Override
	public ForwardInfo process(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		System.out.println("OrderExchangeProcessService.process()");
		...
		if (id != null) {
			...
			try {
				...
				// 수량 돌려 놓기
				orderDao.plusGoodsCount(con, selectedOrderList);
				
				orderDao.updateRefundProcess(con,id,selectedOrderList);				
				
				url = "/cosmetic/order/adminView.do?orderNo=" + orderNo;
