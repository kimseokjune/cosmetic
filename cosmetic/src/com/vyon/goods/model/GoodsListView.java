...
public class GoodsListView {
	...
	public GoodsListView(int totalRow, int totalPage, int startRow, int endRow, 
			int startPage, int endPage, int page, int rowPerPage, int totalRowSysdate, List<Goods> list){
