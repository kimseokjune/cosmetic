...
public class GoodsAdminListService implements Service {

	@Override
	public ForwardInfo process(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		System.out.println("GoodsAdminListService.process()");				
		...
		// 필요한 변수들을 선언
		// 현재 페이지
		// 전달 받는 현재페이지 : page/cate/sort/method를 파리미터로 전달 받는다. 
...
//			System.out.println("GoodsAdminListService.process():startPage-" +startPage+", endPage-"+endPage+", totalPage-"+totalPage);
//			System.out.println("GoodsAdminListService.process().totalRow:" +totalRow);
			// dao.admin_list에서 처리된 데이터를 list로 저장할 변수선언
			List<Goods> list
...
//			System.out.println("data.getEndPage():"+data.getEndPage());
		...
		request.setAttribute("admin_right", "../goods/admin_list.jsp");
		
		// 진행방식과 진행되는 곳의 정보를 ForwardInfo 저장하는 처리
		ForwardInfo forwardInfo = new ForwardInfo();
		// 진행방식 : forward : true
		forwardInfo.setForward(true);
		// 진행하는 곳 : /goods/admin_list.jsp
